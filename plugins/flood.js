...
function main() {
    ...
    content += "<div id='game_conteneur'> <h1 class='gradient-gray'>Flood it</h1> <hr class='clear'> <div id='game_canvas'> </div>  <div id='count'>0/25</div> <div id='controler'> <button onclick='grid.color(1)' class='color-1'>       </button> <button onclick='grid.color(2)' class='color-2'>       </button> <button onclick='grid.color(3)' class='color-3'>       </button><br /> <button onclick='grid.color(4)' class='color-4'>       </button> <button onclick='grid.color(5)' class='color-5'>       </button> <button onclick='grid.color(6)' class='color-6'>       </button> </div> <div id='retry'> <a onclick='grid.lose(); grid.generate(); grid.display();'> Retenter ? </a> </div> <hr class='clear' /> </div>  <div id='tabs'> <div id='tabs-1'> <ul> <li>Le but de flood-it est de recouvrir toute la surface du plateau d'une seule couleur en un minimum de coup.</li> <li>Pour cela il suffit de changer la couleur du carré en haut à gauche du plateau, toute les pieces de memes couleur qui touchent cette piece vont à leur tour prendre cette couleur.</li> <li>Chaque fois que vous sélectionnez une couleur le compteur s'incrémente.</li> </ul> </div> <div id='tabs-2'> <div id='score_last'></div> </div> <div id='tabs-3'> <div id='score_joueur'></div> </div> <div id='tabs-4'> <div id='score_partie'></div> </div> </div>";
